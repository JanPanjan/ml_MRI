...
function add_css2(target) {
  append_styles(target, "svelte-1nh0s17", ".flex.svelte-1nh0s17{display:flex;gap:1.4em;flex-wrap:wrap;justify-content:center}.flex.reverse.svelte-1nh0s17{flex-direction:row-reverse}@media(min-width: 992px){.flex.svelte-1nh0s17{flex-wrap:nowrap}}.relative.svelte-1nh0s17{position:relative}.avatar.svelte-1nh0s17{flex:0 0 auto;width:attr(data-size);height:attr(data-size);object-fit:cover;border-radius:6px}.description.svelte-1nh0s17{flex:1 1 auto;word-break:break-word;padding:6px;border-radius:6px}.textarea.svelte-1nh0s17{width:100%;height:100%;resize:none}.with-placeholder.svelte-1nh0s17:empty:before{content:attr(data-placeholder);color:var(--text-faint);font-style:italic}");
}
...
function create_fragment3(ctx) {
  ...
  return {
    c() {
      ...
      if (if_block1)
        if_block1.c();
      attr(img, "class", "avatar svelte-1nh0s17");
      attr(img, "alt", "Avatar");
      ...
      attr(div0, "class", "avatar relative svelte-1nh0s17");
      set_style(div0, "width", `${/*avatarSize*/
      ctx[6]}px`);
      set_style(div0, "height", `${/*avatarSize*/
      ctx[6]}px`);
      attr(textarea, "class", "textarea svelte-1nh0s17");
      textarea.hidden = textarea_hidden_value = !/*editMode*/
      ctx[3];
      attr(textarea, "placeholder", "Write your story...");
      attr(span, "class", "avatar-plugin--md-preview with-placeholder svelte-1nh0s17");
      span.hidden = /*editMode*/
      ctx[3];
      attr(span, "data-placeholder", "Write your story...");
      attr(div1, "class", "description relative svelte-1nh0s17");
      attr(div2, "class", "flex svelte-1nh0s17");
      toggle_class(
        div2,
        "reverse",
        /*state*/
